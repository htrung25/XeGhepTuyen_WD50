...
class TripResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'revenue' => (float) ($this->completed_revenue ?? ($this->relationLoaded('bookings') ? $this->bookings->where('booking_status', 'completed')->sum('final_amount') : $this->bookings()->where('booking_status', 'completed')->sum('final_amount'))),
