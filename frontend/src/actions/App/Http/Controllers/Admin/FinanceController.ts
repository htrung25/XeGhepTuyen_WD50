 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:35
 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:198
 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:252
 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:67
 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:431
...
/**
* @see \App\Http\Controllers\Admin\FinanceController::revenue
 * @see app/Http/Controllers/Admin/FinanceController.php:462
 * @route '/api/admin/finance/revenue'
 */
...
/**
* @see \App\Http\Controllers\Admin\FinanceController::anomalies
 * @see app/Http/Controllers/Admin/FinanceController.php:372
 * @route '/api/admin/finance/anomalies'
 */
...
anomalies.definition = {
    methods: ["get","head"],
    url: '/api/admin/finance/anomalies',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Admin\FinanceController::exportMethod
 * @see app/Http/Controllers/Admin/FinanceController.php:394
 * @route '/api/admin/finance/export'
 */
 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:76
 * @route '/api/admin/finance/payouts'
 */
 ...
 * @see app/Http/Controllers/Admin/FinanceController.php:270
...
/**
* @see \App\Http\Controllers\Admin\FinanceController::confirmPayment
 * @see app/Http/Controllers/Admin/FinanceController.php:332
 * @route '/api/admin/finance/payments/{payment}/confirm'
 */
export const confirmPayment = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
confirmPayment.definition = {
    methods: ["post"],
    url: '/api/admin/finance/payments/{payment}/confirm',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/api/admin/finance/payments/{payment}/confirm'
 */
confirmPayment.url = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { payment: args }
    }
 ...
 * @route '/api/admin/finance/payments/{payment}/confirm'
 */
confirmPayment.post = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: confirmPayment.url(args, options),
    method: 'post',
})
 ...
 * @route '/api/admin/finance/payments/{payment}/confirm'
 */
    const confirmPaymentForm = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/api/admin/finance/payments/{payment}/confirm'
 */
        confirmPaymentForm.post = (args: { payment: string | number } | [payment: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: confirmPayment.url(args, options),
            method: 'post',
        })
    
    confirmPayment.form = confirmPaymentForm
const FinanceController = { summary, transactions, refunds, commissions, payouts, revenue, anomalies, exportMethod, payout, refund, confirmPayment, export: exportMethod }
