...
* @see app/Http/Controllers/Operator/RouteController.php:15
...
* @see app/Http/Controllers/Operator/RouteController.php:26
* @route '/api/operator/routes'
*/
...
* @see app/Http/Controllers/Operator/RouteController.php:57
...
* @see app/Http/Controllers/Operator/RouteController.php:68
* @route '/api/operator/routes/{id}'
*/
...
* @see app/Http/Controllers/Operator/RouteController.php:89
* @route '/api/operator/routes/{id}'
*/
