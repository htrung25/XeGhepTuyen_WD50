...
* @see app/Http/Controllers/Customer/BookingController.php:60
...
* @see app/Http/Controllers/Customer/BookingController.php:30
...
* @see app/Http/Controllers/Customer/BookingController.php:82
* @route '/api/customer/bookings'
*/
...
* @see app/Http/Controllers/Customer/BookingController.php:49
...
* @see app/Http/Controllers/Customer/BookingController.php:112
...
* @see app/Http/Controllers/Customer/BookingController.php:147
...
* @see app/Http/Controllers/Customer/BookingController.php:161
...
export const downloadTicket = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: downloadTicket.url(args, options),
    method: 'get',
})

downloadTicket.definition = {
    methods: ["get","head"],
    url: '/api/customer/bookings/{id}/ticket.pdf',
} satisfies RouteDefinition<["get","head"]>
...
downloadTicket.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    ...
    return downloadTicket.definition.url
            .replace('{id}', parsedArgs.id.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
const downloadTicketForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: downloadTicket.url(args, options),
    method: 'get',
})
...
downloadTicketForm.head = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: downloadTicket.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
downloadTicket.form = downloadTicketForm

const BookingController = { lockSeats, index, store, show, cancel, qr, downloadTicket }
