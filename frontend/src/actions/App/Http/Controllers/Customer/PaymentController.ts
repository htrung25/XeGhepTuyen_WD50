 ...
 * @see app/Http/Controllers/Customer/PaymentController.php:61
 ...
 * @see app/Http/Controllers/Customer/PaymentController.php:82
 ...
 * @see app/Http/Controllers/Customer/PaymentController.php:99
 ...
 * @see app/Http/Controllers/Customer/PaymentController.php:27
 ...
 * @see app/Http/Controllers/Customer/PaymentController.php:143
 ...
 * @see app/Http/Controllers/Customer/PaymentController.php:169
 ...
 * @route '/api/customer/payments/by-order/{orderId}'
 */
statusByOrder.head = (args: { orderId: string | number } | [orderId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: statusByOrder.url(args, options),
    method: 'head',
})
 ...
 * @route '/api/customer/payments/by-order/{orderId}'
 */
    const statusByOrderForm = (args: { orderId: string | number } | [orderId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: statusByOrder.url(args, options),
        method: 'get',
    })
 ...
 * @route '/api/customer/payments/by-order/{orderId}'
 */
        statusByOrderForm.get = (args: { orderId: string | number } | [orderId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: statusByOrder.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/api/customer/payments/by-order/{orderId}'
 */
        statusByOrderForm.head = (args: { orderId: string | number } | [orderId: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: statusByOrder.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    statusByOrder.form = statusByOrderForm
/**
* @see \App\Http\Controllers\Customer\PaymentController::wallet
 * @see app/Http/Controllers/Customer/PaymentController.php:193
