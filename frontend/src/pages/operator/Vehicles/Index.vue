                        ...
                        >
                            ...
                            <td class="px-5 py-3 text-center">
                                <button
                                    ...
                                    class="cursor-pointer rounded-lg bg-amber-50 px-3 py-1.5 text-xs font-medium text-amber-700 transition-colors hover:bg-amber-100"
                                >
                                    Xem chi tiết
                                </button>
                            </td>
                            ...
                            <td class="px-5 py-3 text-center">
                                ...
                                >
                                    <button
                                        ...
                                        class="cursor-pointer rounded-lg bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-700 transition-colors hover:bg-slate-200"
                                    >
                                        Xem chi tiết
                                    </button>
                                    <button
        ...
        <Teleport to="body">
            ...
            >
                ...
                >
                    ...
                    <button
                        @click="detailVehicleModal = false"
                        class="absolute top-4 right-4 cursor-pointer rounded-full p-1.5 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600"
                    >
                        <svg
                            class="h-5 w-5"
                            fill="none"
                    ...
                    <div class="mb-5 flex items-center gap-3">
                        <span
                            class="rounded bg-amber-500 px-2.5 py-1 font-mono text-xs font-bold tracking-wider text-white uppercase"
                        >
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div
                            class="flex h-48 items-center justify-center overflow-hidden rounded-xl border border-gray-100 bg-gray-50 md:h-auto"
                        >
                            <img
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-1.5">
                                    <span
                                        ...
                                        []"
                                        :key="a"
                                        class="inline-flex items-center gap-1 rounded border border-amber-100 bg-amber-50 px-2 py-1 text-xs font-medium text-amber-800"
                                    >
                            ...
                            <div class="border-t border-slate-100 pt-2">
                                <span
                                    class="mb-2 block text-xs font-semibold text-slate-500"
                                    >Tài xế đang gán</span
                                >
                                <div
                                    v-if="selectedVehicle?.current_driver"
                                    class="flex items-center gap-3 rounded-xl border border-green-100/50 bg-green-50/50 p-3"
                                >
                                    <div
                                ...
                                <div
                                    v-else
                                    class="flex items-center gap-2 rounded-xl bg-slate-50 p-3"
                                >
                                    <span class="text-sm text-gray-400"
                                        >⚠️</span
                                    >
                                    <span class="text-xs text-slate-500"
                                        >Chưa gán tài xế cố định cho phương tiện
                                        này.</span
                                    >
                                </div>
                            </div>
                    ...
                    <div class="mt-6 flex justify-end">
                        <button
                            @click="detailVehicleModal = false"
                            class="cursor-pointer rounded-xl bg-gray-900 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-gray-800"
                        >
                            Đóng cửa sổ
                        </button>
                    </div>
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-12">
                        ...
                        <div class="space-y-4 md:col-span-5">
                            ...
                            >
                                <div
                                    class="mx-auto mb-2 flex h-14 w-14 items-center justify-center rounded-full bg-amber-100 ring-4 ring-amber-50"
                                >
                                    <span
                            ...
                            <div class="space-y-2.5">
                                ...
                                >
                                    ...
                                    <div class="flex items-center gap-0.5">
                                        <template
                                            v-if="selectedDriver?.rating_avg"
                                        >
                                            <span
                                                class="font-bold text-slate-800"
                                                >{{
                                                    selectedDriver?.rating_avg?.toFixed(
                                                        1,
                                                    )
                                                }}</span
                                            >
                            ...
                            <div class="border-t border-slate-100 pt-3">
                                ...
                                >
                                <div
                                    v-if="selectedDriver?.current_vehicle"
                                    class="flex items-center gap-2.5 rounded-xl border border-amber-100/50 bg-amber-50/40 p-2.5"
                                >
                                    <span class="text-lg">🚐</span>
                                    <div>
                                        <p
                                            class="font-mono text-xs font-bold text-slate-800 uppercase"
                                        >
                                            {{
                                ...
                                <div
                                    v-else
                                    class="rounded-xl bg-slate-50 py-3 text-center"
                                >
                        ...
                        <div
                            class="space-y-4 border-t border-slate-100 pt-4 md:col-span-7 md:border-t-0 md:border-l md:pt-0 md:pl-6"
                        >
                            <!-- CCCD/CMND Section -->
                            <div class="space-y-2">
                                <div class="flex items-center justify-between">
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    <div>
                                        <span
                                            class="mb-1 block text-center text-[9px] font-medium text-slate-400"
                                            >Mặt trước CCCD</span
                                        >
                                        <a
                                            v-if="
                                                selectedDriver?.id_card_front_url
                                            "
                                            :href="
                                                selectedDriver?.id_card_front_url
                                            "
                                            target="_blank"
                                            class="group relative block aspect-[3/2] overflow-hidden rounded-lg border border-slate-200 bg-slate-50"
                                        >
                                            <img
                                                :src="
                                                    selectedDriver?.id_card_front_url
                                            ...
                                            />
                                            <div
                                                class="animate-fade-in absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 transition-opacity group-hover:opacity-100"
                                            >
                                                <span
                                        ...
                                        <div
                                            v-else
                                            class="flex aspect-[3/2] items-center justify-center rounded-lg border border-dashed border-slate-200 bg-slate-50/50 text-xs text-slate-300 italic"
                                        >
                                            Chưa tải lên
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <a
                                            v-if="
                                                selectedDriver?.id_card_back_url
                                            "
                                            :href="
                                                selectedDriver?.id_card_back_url
                                            "
                            ...
                            >
                                ...
                                <div class="mt-2">
                                    ...
                                    <a
                                        ...
                                        "
                                        target="_blank"
                                        class="group relative mx-auto block aspect-[16/10] max-w-[240px] overflow-hidden rounded-lg border border-slate-200 bg-slate-50"
                                    >
                                        <img
                                            :src="
                                                selectedDriver?.license_front_url
                                    ...
                                    <div
                                        v-else
                                        class="mx-auto flex aspect-[16/10] max-w-[240px] items-center justify-center rounded-lg border border-dashed border-slate-200 bg-slate-50/50 text-xs text-slate-300 italic"
                                    >
                                        Chưa tải lên
                                    </div>
                                </div>
                    ...
                    >
                        <button
                            @click="detailDriverModal = false"
                            class="cursor-pointer rounded-xl bg-gray-900 px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-gray-800"
                        >
                            Đóng cửa sổ
                        </button>
                    </div>
