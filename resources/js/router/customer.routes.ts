    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: 'partner',
                component: () =>
                    import('@/pages/customer/partner/Register.vue'),
                meta: { requiresAuth: false },
            },
            {
                path: 'search',
                component: () => import('@/pages/customer/trips/Results.vue'),
                meta: { requiresAuth: false },
            },
            {
                path: 'trips/:id/seats',
                component: () =>
                    import('@/pages/customer/trips/SeatPicker.vue'),
                meta: { requiresAuth: false },
            },
            {
                path: 'booking/checkout',
                component: () =>
                    import('@/pages/customer/booking/Checkout.vue'),
            ...
            },
            {
                ...
                component: () =>
                    import('@/pages/customer/booking/Confirmation.vue'),
                meta: { requiresAuth: true },
            },
            {
                path: 'bookings',
            ...
            },
            {
                ...
                component: () =>
                    import('@/pages/customer/tracking/LiveMap.vue'),
                meta: { requiresAuth: true },
            },
            {
