...
export const driverRoutes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'dashboard',  component: () => import('@/pages/driver/Dashboard.vue') },
      { path: 'schedule',   component: () => import('@/pages/driver/trips/Schedule.vue') },
      {
        path: 'trips/:id',
      ...
      { path: 'earnings',   component: () => import('@/pages/driver/earnings/Summary.vue') },
