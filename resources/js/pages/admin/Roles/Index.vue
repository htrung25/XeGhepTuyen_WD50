...
function isModuleAllChecked(group: PermissionGroup): boolean {
    return group.permissions.every((p) =>
        form.value.permissions.includes(p.key),
    );
}
    ...
    <div class="mx-auto max-w-7xl p-6">
        ...
        <div v-if="loading" class="space-y-3">
            <div
                v-for="i in 4"
                :key="i"
                class="h-20 animate-pulse rounded-xl border border-slate-200 bg-white"
            />
        </div>
                ...
                >
                    ...
                    <div class="flex-1 space-y-5 overflow-y-auto p-6">
                        ...
                        <p
                            ...
                            class="rounded-lg bg-amber-50 p-3 text-xs text-amber-700"
                        >
                        ...
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                <div
                                    class="grid grid-cols-1 gap-2 pl-6 sm:grid-cols-2"
                                >
                                    <label
